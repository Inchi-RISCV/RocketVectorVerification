`ifndef GUARD_TILELINK_SLAVE_RESP_WO_REQ_ERROR_CALLBACK
`define GUARD_TILELINK_SLAVE_RESP_WO_REQ_ERROR_CALLBACK

/**
 * Abstract: 
 * class 'tilelink_slave_resp_wo_req_error_callback' is extended from svt_tilelink_slave_callback class.
 * It implements the post_seq_item_get method to set clk stall scenario from slave.
 * This call back is used to insert 
 */

class tilelink_slave_resp_wo_req_error_callback extends svt_tilelink_slave_callback;
  ...
  virtual function void post_seq_item_get(svt_tilelink_slave slave, svt_tilelink_slave_transaction xact, ref bit drop);
    ...
    tilelink_slave_exception.error_kind = svt_tilelink_slave_transaction_exception::RESP_WITHOUT_REQ_ERR;
...
endclass: tilelink_slave_resp_wo_req_error_callback
`endif //GUARD_TILELINK_SLAVE_RESP_WO_REQ_ERROR_CALLBACK
