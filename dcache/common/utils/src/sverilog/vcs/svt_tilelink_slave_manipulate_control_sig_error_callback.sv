`ifndef GUARD_SVT_TILELINK_SLAVE_MANIPULATE_CONTROL_SIG_ERROR_CALLBACK
`define GUARD_SVT_TILELINK_SLAVE_MANIPULATE_CONTROL_SIG_ERROR_CALLBACK

/**
 * Abstract: 
 * class 'svt_tilelink_slave_manipulate_control_sig_error_callback' is extended from svt_tilelink_slave_callback class. <br>
...
class svt_tilelink_slave_manipulate_control_sig_error_callback extends svt_tilelink_slave_callback;
  ...
  virtual function void post_seq_item_get(svt_tilelink_slave slave, svt_tilelink_slave_transaction xact, ref bit drop);
    ...
    tilelink_slave_exception.error_kind = svt_tilelink_slave_transaction_exception::REQ_B_CNTRL_SIG_ERR;
    tilelink_slave_exception.b_control_sig        = this.b_ctrl_sig;
    tilelink_slave_exception.b_control_sig_beat   = this.b_ctrl_sig_beat;
    tilelink_slave_exception.b_opcode = this.corrupt_opc_val;
    tilelink_slave_exception.b_size = this.corrupt_size_val;
    tilelink_slave_exception.b_addr = this.corrupt_addr_val;
    tilelink_slave_exception.b_source = this.corrupt_src_val;
    tilelink_slave_exception.b_param= this.corrupt_param_val;
...
endclass: svt_tilelink_slave_manipulate_control_sig_error_callback
`endif //GUARD_svt_tilelink_slave_manipulate_control_sig_error_callback
