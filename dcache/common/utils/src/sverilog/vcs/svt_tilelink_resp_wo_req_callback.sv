`ifndef GUARD_TILELINK_SLAVE_RESP_WO_REQ_CALLBACK
`define GUARD_TILELINK_SLAVE_RESP_WO_REQ_CALLBACK
...
class tilelink_slave_resp_wo_req_callback extends svt_tilelink_slave_callback;

  rand bit [3:0] d_source;
...
endclass: tilelink_slave_resp_wo_req_callback
`endif //GUARD_TILELINK_SLAVE_RESP_WO_REQ_CALLBACK
