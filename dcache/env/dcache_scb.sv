  ...
  act_tr = new();
    ...
    while(1)begin
     ...
     // comp refill rsp
       ...
       if(rsp_refill_act_tr.io_resp_bits_source != refill_exp_tr.io_resp_bits_source || rsp_refill_act_tr.io_resp_bits_dest != refill_exp_tr.io_resp_bits_dest || rsp_refill_act_tr.io_resp_bits_size != refill_exp_tr.io_resp_bits_size || rsp_refill_act_tr.io_resp_bits_status != refill_exp_tr.io_resp_bits_status || rsp_refill_act_tr.io_resp_bits_hasData != refill_exp_tr.io_resp_bits_hasData  || rsp_refill_act_tr.io_resp_bits_data != refill_exp_tr.io_resp_bits_data )begin
			   `uvm_error(get_type_name(),$sformatf(" refill rsp compare fail!\nExpect dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h,data=%0h\nActual dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h,data=%0h",refill_exp_tr.io_resp_bits_dest,refill_exp_tr.io_resp_bits_source,refill_exp_tr.io_resp_bits_size,refill_exp_tr.io_resp_bits_status,refill_exp_tr.io_resp_bits_hasData,refill_exp_tr.io_resp_bits_data,rsp_refill_act_tr.io_resp_bits_dest,rsp_refill_act_tr.io_resp_bits_source,rsp_refill_act_tr.io_resp_bits_size,rsp_refill_act_tr.io_resp_bits_status,rsp_refill_act_tr.io_resp_bits_hasData,rsp_refill_act_tr.io_resp_bits_data));
			 end
			 else begin
         `uvm_info(get_type_name(),$sformatf("refill rsp compare pass,dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h,data=%0h",rsp_refill_act_tr.io_resp_bits_dest,rsp_refill_act_tr.io_resp_bits_source,rsp_refill_act_tr.io_resp_bits_size,rsp_refill_act_tr.io_resp_bits_status,rsp_refill_act_tr.io_resp_bits_hasData,rsp_refill_act_tr.io_resp_bits_data),UVM_NONE)
			 end
     end
     ...
     //comp hit&miss rsp
       ...
       rsp_exp_tr = rsp_exp_q.pop_front();
			 if(rsp_act_tr.io_resp_bits_source != rsp_exp_tr.io_resp_bits_source || rsp_act_tr.io_resp_bits_dest != rsp_exp_tr.io_resp_bits_dest || rsp_act_tr.io_resp_bits_size != rsp_exp_tr.io_resp_bits_size || rsp_act_tr.io_resp_bits_status != rsp_exp_tr.io_resp_bits_status || rsp_act_tr.io_resp_bits_hasData != rsp_exp_tr.io_resp_bits_hasData)begin
				 `uvm_error(get_type_name(),$sformatf("rsp compare fail!\nExpect dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h\nActual dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h",rsp_exp_tr.io_resp_bits_dest,rsp_exp_tr.io_resp_bits_source,rsp_exp_tr.io_resp_bits_size,rsp_exp_tr.io_resp_bits_status,rsp_exp_tr.io_resp_bits_hasData,rsp_act_tr.io_resp_bits_dest,rsp_act_tr.io_resp_bits_source,rsp_act_tr.io_resp_bits_size,rsp_act_tr.io_resp_bits_status,rsp_act_tr.io_resp_bits_hasData));
			 end
			 else begin
         `uvm_info(get_type_name(),$sformatf("rsp compare pass,dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h",rsp_act_tr.io_resp_bits_dest,rsp_act_tr.io_resp_bits_source,rsp_act_tr.io_resp_bits_size,rsp_act_tr.io_resp_bits_status,rsp_act_tr.io_resp_bits_hasData),UVM_NONE)
			 end

		   if(rsp_act_tr.io_resp_bits_hasData)begin
			   if(rsp_act_tr.io_resp_bits_data != rsp_exp_tr.io_resp_bits_data)begin
				   `uvm_error(get_type_name(),$sformatf("rsp compare fail!\nExpect dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h,data=%0h\nActual dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h,data=%0h",rsp_exp_tr.io_resp_bits_dest,rsp_exp_tr.io_resp_bits_source,rsp_exp_tr.io_resp_bits_size,rsp_exp_tr.io_resp_bits_status,rsp_exp_tr.io_resp_bits_hasData,rsp_exp_tr.io_resp_bits_data,rsp_act_tr.io_resp_bits_dest,rsp_act_tr.io_resp_bits_source,rsp_act_tr.io_resp_bits_size,rsp_act_tr.io_resp_bits_status,rsp_act_tr.io_resp_bits_hasData,rsp_act_tr.io_resp_bits_data));
			   end
			 else begin
				 `uvm_info(get_type_name(),$sformatf("rsp compare pass,dest=%0h,source=%0h,size=%0h,status=%0h,hasdata=%0h,data=%0h",rsp_act_tr.io_resp_bits_dest,rsp_act_tr.io_resp_bits_source,rsp_act_tr.io_resp_bits_size,rsp_act_tr.io_resp_bits_status,rsp_act_tr.io_resp_bits_hasData,rsp_act_tr.io_resp_bits_data),UVM_NONE)
			 end
